...
- [X ] `1.2`, `1.3` e `2.0` aparecem em **⚠️ Legado** com prefixo `[LEGADO]`
- [X ] Ao abrir cada legada, o banner amarelo aparece no topo
- [X ] App sobe sem erro (`streamlit run app_home.py`)
